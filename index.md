...
1. **Ruba Abu-Salma**, M. Angela Sasse, Joseph Bonneau, Anastasia Danilova, Alena Naiakshina, and Matthew Smith. Obstacles to the Adoption of Secure Communication Tools. In Proceedings of the [38th IEEE Symposium on Security and Privacy (Oakland)](http://www.ieee-security.org/TC/SP2017/index.html), San Jose, CA, USA, 2017. (**Invited paper to IEEE Security and Privacy Magazine, 2017**) [[**...**](https://boingboing.net/2017/05/31/why-dont-people-use-secure-i.html)] [[**...**](https://www.eff.org/deeplinks/2018/03/secure-messaging-more-secure-mess)]
